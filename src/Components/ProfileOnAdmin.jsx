...
function ProfileOnAdmin() {
        ...
        useEffect(() => {
            const fetchStudent = async () => {
                try {
                    const response = await axios.get('http://localhost:8080/api/get-student-by-id', {
                        params: { id }
                    });
        ...
        useEffect(() => {
            const fetchResults = async () => {
                if (student) {
                    try {
                        const response = await axios.get(`http://localhost:8080/api/quizzes/results/${student.email}`);
